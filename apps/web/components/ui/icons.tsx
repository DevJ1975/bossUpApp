...
export const MessageSquareHeart = (p: IconProps) => (
  <Svg {...p}>
    ...
    <path d="M12 13.5s-2.4-1.6-2.4-3.1a1.3 1.3 0 0 1 2.4-.7 1.3 1.3 0 0 1 2.4.7c0 1.5-2.4 3.1-2.4 3.1z" />
  </Svg>
);
...
/** Maps the `icon` strings used in site.config to icon components. */
export const featureIcons: Record<string, ComponentType<IconProps>> = {
  Smartphone,
  MessageSquareHeart,
  Route,
  TrendingUp,
